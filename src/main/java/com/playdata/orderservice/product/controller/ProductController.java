...
public class ProductController {
    ...
    public ResponseEntity<?> productDelete(@RequestParam Long id) throws MalformedURLException, UnsupportedEncodingException {
        log.info("/product/delete: DELETE id: {}",id);
        productService.productDelete(id);

        CommonResDto resDto = new CommonResDto(HttpStatus.OK, "삭제 완료", null);
        return new ResponseEntity<>(resDto, HttpStatus.OK);
    }
